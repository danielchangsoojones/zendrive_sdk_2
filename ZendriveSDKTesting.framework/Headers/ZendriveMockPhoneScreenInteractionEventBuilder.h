...
/**
 * An event builder for [phone screen interaction](https://zendrive-root.bitbucket.io/ios/docs/sdk-7.0.0/Enums/ZendriveEventType.html#/c:@E@ZendriveEventType@ZendriveEventPhoneScreenInteraction) event.
 */
