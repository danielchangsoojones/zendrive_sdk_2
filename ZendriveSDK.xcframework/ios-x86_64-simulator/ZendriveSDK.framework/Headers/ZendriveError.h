...
typedef NS_ENUM(int, ZendriveError) {
    ...
    /**
     * Operation failed because `ZendriveRegion` provided was invalid.
     */
    kZendriveErrorInvalidRegion = 108,

    /**
     * Operation Failed because provided `ZendriveRegion` is not supported for this application.
     */
     ...
     */
    kZendriveUnsupportedVehicleType = 112
