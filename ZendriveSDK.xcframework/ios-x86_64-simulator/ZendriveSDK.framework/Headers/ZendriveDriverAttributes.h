 ...
 */
typedef NS_ENUM(int, ZendriveVehicleType) {
    /**
 ...
 * To enable the feature for any vehicle type other than `ZendriveVehicleType.ZendriveVehicleTypeCar`,
 * please contact us at support@zendrive.com.
 * @param vehicleType The `ZendriveVehicleType` for the driver.
 * Passing `ZendriveVehicleType.ZendriveVehicleTypeUnknown` is a no-op.
 *
 * @return YES, if the value was set, NO otherwise.
 */
- (BOOL)setVehicleType:(ZendriveVehicleType)vehicleType;
